...
import logo from "../../assets/header_omega_petshop.png";
                    ...
                    usuario.estadologin === EstadoLogin.NO_LOGUEADO ? (
                        <>
                            ...
                            <div className="col-md-3 text-end">
                                <a href="/login" type="button" className="btn btn-mg btn-primary me-2">Ingresar</a>
                                <a href="/Registar" type="button" className="btn btn-mg btn-warning">Registrar</a>
                            </div>
                        </>
                    ) :
                            ...
                            <>
                                <div className="collapse navbar-collapse" id="menu">
                                    <div className="navbar-nav" style={{ fontWeight: 700 }}>
                                        ...
                                        <a className="nav-link text-light" href="/usuarios">Clientes</a>
                                    </div>
                                </div>
